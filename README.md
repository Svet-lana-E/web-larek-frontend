**"Веб-ларек"** - учебный проект в рамках курсов фронтенд‑разработки Яндекс Практикума. Это имитация онлайн‑магазина, где пользователь может просматривать товары, формировать заказ и оформлять покупку. 

Стек: <img width="24" height="24" alt="image" src="https://github.com/user-attachments/assets/5e0adb2b-243b-4804-96b0-349a46b05f26" /> <img width="24" height="24" alt="image" src="https://github.com/user-attachments/assets/b3a1e62d-1fc0-42d1-a6f1-6772de6f1e6e" />
<img width="24" height="24" alt="image" src="https://github.com/user-attachments/assets/97e4812f-8413-4b88-8003-3a1cb4b3de80" /> <img width="24" height="24" alt="image" src="https://github.com/user-attachments/assets/c0848c48-5a2e-4520-b1a8-ebc5412918cc" />
...
- 'set selected(value: boolean)' - отображает состояние активности кнопки 'submit'
